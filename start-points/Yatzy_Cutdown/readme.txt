...
For example, if a player rolls 5,6,5,6,2 and scores the dice in the two-pairs category they would score 22 (5+5+6+6).
...
Yatzy:
If all dice have the same number, the player scores 50 points, otherwise 0.
  For example,
